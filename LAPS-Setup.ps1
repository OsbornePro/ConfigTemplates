...
$Member = Get-ADPrincipalGroupMembership -Identity radmin | Where-Object { $_.Name -eq "Schema Admins" }
If (!($Member)) {
    ...
    If ($Answer -like "*y*")
    {
        ...
        Write-Warning "Schema can not be updated with the current user"
